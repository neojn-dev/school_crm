        ...
        <div className="cms-page-header">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p className="mt-2 text-lg text-gray-600">Manage page templates and layouts for consistent design</p>
        ...
        <div className="cms-content-section">
          <div className="cms-card">
            <div className="cms-card-header">
              ...
              <p className="text-sm text-gray-600">Browse templates by category</p>
            </div>
            ...
            <div className="p-6">
              ...
              <div className="flex items-center justify-between">
                <Link href={`/cms/templates/${template.id}/edit`}>
                  <Button size="sm" className="flex items-center space-x-2 px-4">
